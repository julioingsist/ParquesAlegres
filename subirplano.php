...
<html> 
<head> 
<title>Subir plano de parque</title> 
<style> 
...
<div > 
<fieldset><legend>Subir planos del parque:</legend> <!-- los tag <fieldset> y <legend> son con fines decorativos hacen un recuadro con titulo alrededor del form--> 
<form method="POST" action="subirplano.php" enctype="multipart/form-data"> 
<?
if (file_exists('planos/'.$parque.'.jpg')) {
		echo '<div class="estilo_divs">plano: </th><td><img src="planos/'.$parque.'.jpg"></div>';
		echo '<div class="estilo_divs">Cambiar imagen: </th><td><input type="file" name="archivo" size=50></div>';
		}else{
		echo '<div class="estilo_divs">plano: </th><td>No existe imagen actualmente</td></tr>';
		echo '<div class="estilo_divs">Agregar Imagen: </th><td><input type="file" name="archivo" size=50></div>';
		}
		?>
