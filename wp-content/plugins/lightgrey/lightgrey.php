...
Skin URI: 
Description: LightGrey Skin for Flash Album Gallery. <br /><br />Details: bottom thumbnails, fullscreen button (FS), slideshhow button (SL), backlink to PhotoGalleryCreator.com (PGC), image description button (i)
Author: PGC
