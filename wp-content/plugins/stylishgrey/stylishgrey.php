<?php
/*
Skin Name: StylishGrey Skin
Skin URI: 
Description: StylishGrey Skin for Flash Album Gallery. <br /><br />Details: bottom thumbnails, fullscreen button (FS), slideshhow button (SL), backlink to PhotoGalleryCreator.com (PGC), image description button (i)
Author: PGC
...
jQuery(document).ready(function() {
	...
	jQuery("#skin_default").click(function(){
		...
		jQuery("#flashBackcolor")			.val('d5dadd');
		jQuery("#buttonsBG")				.val('565f68');
		jQuery("#buttonsMouseOver")			.val('74c20e');
		jQuery("#buttonsMouseOut")			.val('ffffff');
		jQuery("#catButtonsMouseOver")		.val('565f68');
		jQuery("#catButtonsMouseOut")		.val('565f68');
		jQuery("#catButtonsTextMouseOver")	.val('74c20e');
		jQuery("#catButtonsTextMouseOut")	.val('ffffff');
		jQuery("#thumbMouseOver")			.val('99d24e');
		jQuery("#thumbMouseOut")			.val('565f68');
		jQuery("#mainTitle")				.val('000000');
		jQuery("#categoryTitle")			.val('74c20e');
		jQuery("#itemBG")					.val('565f68');
		jQuery("#itemTitle")				.val('74c20e');
		jQuery("#itemDescription")			.val('565f68');
		tChecked();
		return false;
	});
});
