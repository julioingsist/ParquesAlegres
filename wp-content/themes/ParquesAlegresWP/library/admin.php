...
function joints_rss_dashboard_widget() {
	...
	<h4 style="margin-bottom: 0;">
		<a href="<?php echo $item->get_permalink(); ?>" title="<?php echo mysql2date(__('j F Y @ g:i a', 'ParquesAlegres'), $item->get_date('Y-m-d H:i:s')); ?>" target="_blank">
...
function joints_custom_dashboard_widgets() {
	wp_add_dashboard_widget('joints_rss_dashboard_widget', __('Recently on Themble (Customize on admin.php)', 'ParquesAlegres'), 'joints_rss_dashboard_widget');
	/*
...
function joints_custom_admin_footer() {
	_e('<span id="footer-thankyou">Developed by <a href="http://zoma.rs" target="_blank">zomars</a> for <a href="http://anclastudio.com" target="_blank">Ancla Studio</a></span> . Built using <a href="http://themble.com/joints" target="_blank">joints</a>.', 'ParquesAlegres');
}
