...
function custom_post_example() {
	...
	register_post_type( 'custom_type', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		...
		array('labels' => array(
			'name' => __('Custom Types', 'ParquesAlegres'), /* This is the Title of the Group */
			'singular_name' => __('Custom Post', 'ParquesAlegres'), /* This is the individual type */
			'all_items' => __('All Custom Posts', 'ParquesAlegres'), /* the all items menu item */
			'add_new' => __('Add New', 'ParquesAlegres'), /* The add new menu item */
			'add_new_item' => __('Add New Custom Type', 'ParquesAlegres'), /* Add New Display Title */
			'edit' => __( 'Edit', 'ParquesAlegres' ), /* Edit Dialog */
			'edit_item' => __('Edit Post Types', 'ParquesAlegres'), /* Edit Display Title */
			'new_item' => __('New Post Type', 'ParquesAlegres'), /* New Display Title */
			'view_item' => __('View Post Type', 'ParquesAlegres'), /* View Display Title */
			'search_items' => __('Search Post Type', 'ParquesAlegres'), /* Search Custom Type Title */
