...
//$b = get_post_meta($post->ID, "_parque_maps", true);
        echo'<table><tr><th>Nombre de parque:</th><th align="center">'.$post->post_title.'</th></tr>
          ...
          <tr><th>Superficie</th><td>'.get_post_meta($parque, "_parque_sup", true).' m&#178;</td></tr>
	   ...
	   $sector=array(1 => 'Noreste (NE)', 2 => 'Noroeste (NO)', 3 => 'Sureste (SE)', 4 => 'Suroeste (SO)');
        ...
        //echo $sector[get_post_meta($post->ID, "_parque_sec", true)];
          echo'<tr><th>Sector</th><td>'.$sector[get_post_meta($post->ID, "_parque_sec", true)].'</td></tr>';
