<?php
/*
Template Name: Evaluación de parques
*/
?>
...
if($_POST)
{
		...
		if($comite1_parque=="No hay comitÈ"){$puntos_comite1=0;}
		...
		if($comite3_parque=="M·s o menos"){$puntos_comite3=50;}
		...
		if($instalaciones2_parque=="M·s o menos"){$puntos_instalaciones2=50;}
		...
		if($ingresos1_parque=="M·s o menos"){$puntos_ingresos1=75;}
		...
		if($ingresos2_parque=="M·s o menos"){$puntos_ingresos2=50;}
		...
		if($verdes1_parque=="¡rboles grandes"){ $puntos_verdes1=0;}
		if($verdes1_parque=="¡rboles chicos"){$puntos_verdes1=0;}
		...
		if($verdes2_parque=="Falta un poco m·s"){$puntos_verdes2=75;}
		...
		if($verdes3_parque=="M·s o menos"){$puntos_verdes3=50;}
		...
		if($afluencia1_parque=="M·s o menos"){$puntos_afluencia1=60;}
		...
		$subject = "Evaluación de Parque";
		$email="contacto@parquesalegres.org";
		$message = "<html><body>";
		$message .="Nombre del parque: <b>".$nombre_parque." </b>";
		$message .="Contacto: <b>".$contacto_parque." </b>";
		$message .="Correo: <b>".$correo_parque." </b>";
		$message .="Calificacion: <b>".round($promedio)." </b>";
		$message .= "</body></html>";
		$cabeceras = "From: Parques Alegres " . $email . "\r\n" .
		"CC: espinosagarciaguillermo@gmail.com, gudart@parquesalegres.org\r\n";
		//$cabeceras .= "CC: otracasilladeemail@yahoo.com\r\n";
		$cabeceras .= "MIME-Version: 1.0\r\n";
		$cabeceras .= "Content-Type: text/html; charset=UTF-8\r\n";
		$to="armandogamezcaballero@gmail.com";
		//$to="gudart@gmail.com";
		mail($to, $subject, $message, $cabeceras);
		$sql1="INSERT INTO `evaluacion_parque`(`parque`, `contacto`, `email`, `opera`, `formaliza`, `organizacion`, `reuniones`, `proyecto`, `instalaciones`, `estado`, `ingresosr`, `insgresos`, `eventosr`, `tipo`, `averdes`, `sufaverdes`, `estaverdes`, `riegaverdes`, `gente`, `diario`, `dia`, `noche`, `limpio`, `respeta`) VALUES ('".$nombre_parque."','".$contacto_parque."','".$correo_parque."','".$comite1_parque."','".$comite2_parque."','".$comite3_parque."','".$comite4_parque."','".$comite5_parque."','".$instalaciones1_parque."','".$instalaciones2_parque."','".$ingresos1_parque."','".$ingresos2_parque."','".$eventos1_parque."','".$eventos2_parque."','".$verdes1_parque."','".$verdes2_parque."','".$verdes3_parque."','".$verdes4_parque."','".$afluencia1_parque."','".$afluencia2_parque."','".$afluencia3_parque."','".$afluencia4_parque."','".$orden1_parque."','".$orden2_parque."')";
...
echo'<li>Es importante contar con un reglamento de orden y seÒalizaciones siendo estos de conocimiento general de los usuarios.</li>';
}
if($orden2_parque=="No"){
echo'<li>Es importante contar con un reglamento de orden y seÒalizaciones siendo estos de conocimiento general de los usuarios.</li>';
}
...
$(document).ready(function() {
		...
		<?php echo'<form action="" method="post" name="forma" id="forma">';
echo'<h1>Cuestionario de autoevaluaci&oacute;n del Parque</h1>

<div>Instrucciones:<br><br>
Estas preguntas te ayudarán a evaluar tu Parque. Si requieres apoyo para entender alguno de los términos utilizados en las preguntas, consulta su significado <a href="http://parquesalegres.org/ver-todo/"> aqu&iacute;</a>. 
</div>
<hr>
<br>
...
<h2>Comit&eacute;</h2>
<br> 
<b>&iquest;Con cuantas personas opera su comit&eacute;?</b>&nbsp;<img src="/tablet/help.png" border="0" class="tooltip2" title="Indicar la cantidad de personas que colaboran con el trabajo, gestión y organización del parque."><br>
...
<br> 
<br><b>&iquest;Su comit&eacute; esta formalizado con el ayuntamiento?</b>&nbsp;<img src="/tablet/help.png" border="0" class="tooltip2" title="Indicar si el comité tiene reconocimiento oficial como una forma de organización ciudadana por el municipio o formalizado por una autoridad legal."><br>
...
<br> 
<br><b>&iquest;En su comit&eacute; hay buena organizaci&oacute;n?</b>&nbsp;<img src="/tablet/help.png" border="0" class="tooltip2" title="Indique si la organización y la participación de los integrantes del comité es la adecuada para llevar a cabo acciones que beneficien al parque."><br>
...
<br> 
<br><b>&iquest;En su comit&eacute; hacen reuniones con regularidad?</b>&nbsp;<img src="/tablet/help.png" border="0" class="tooltip2" title="Señale con qué frecuencia se reúnen los integrantes del comité. Se recomienda que estas reuniones se lleven a cabo una vez al mes."><br>
...
<br> 
<br><b>&iquest;Tienen alg&uacute;n proyecto en marcha para su parque?</b>&nbsp;<img src="/tablet/help.png" border="0" class="tooltip2" title="Señale si han organizado o tienen en operación un proyecto en el parque. Se deberán tomar como proyectos en marcha aquellos que se encuentren en alguna etapa de su realización o que tengan fecha de inicio."><br>
...
<h2>Instalaciones</h2>
<br> 
<b>&iquest;Cuentan con instalaciones en su parque?  (bancas, canchas, &aacute;reas verdes, luminarias, etc.)</b>&nbsp;<img src="/tablet/help.png" border="0" class="tooltip2" title="Indicar si en el parque se cuenta con la infraestructura básica. Como infraestructura básica nos referimos a: luminarias, áreas verdes y banquetas."><br>
...
<br> 
<br><b>&iquest;Lo que existe est&aacute; en buen estado?</b>&nbsp;<img src="/tablet/help.png" border="0" class="tooltip2" title="Indicar si  la infraestructura existente en el parque se encuentra en condiciones óptimas para su utilización por los usuarios."><br>
...
<h2>Ingresos</h2>
<br> 
<b>&iquest;Cuentan con ingresos regulares para su parque?</b>&nbsp;<img src="/tablet/help.png" border="0" class="tooltip2" title="Señalar si el comité cuenta con ingresos constantes (mensuales). Estos pueden ser por concepto de: estanquillo, torneos deportivos, actividad recreativa o aportaciones particulares."><br>
...
<br> 
<br><b>&iquest;Es suficiente lo ingresado para operar bien?</b>&nbsp;<img src="/tablet/help.png" border="0" class="tooltip2" title="Indicar si la cantidad de ingresos con la que cuenta el comité sea suficiente para cubrir los requerimientos de la infraestructura existente en el parque."><br>
...
<h2>Eventos</h2>
<br> 
<b>&iquest;Realizan eventos con regularidad en el a&ntilde;o?</b>&nbsp;<img src="/tablet/help.png" border="0" class="tooltip2" title="Indicar si se lleven a cabo al menos 4 eventos anuales, 3 kermesse y 1 torneos deportivos. Para el caso de los espacios donde no se cuenten con canchas para efectuar torneos, 4 eventos tipo actividad recreativa sería lo ideal."><br>
...
<br> 
<br><b>&iquest;Qu&eacute; tipo de eventos han realizado?(puede elegir dos o m&aacute;s opciones)</b>&nbsp;<img src="/tablet/help.png" border="0" class="tooltip2" title="Seleccione las opciones que describan el tipo de evento que se han realizado."><br>
...
<br> 
<b>&iquest;Su parque cuenta con vegetacion? (puede elegir dos o m&aacute;s opciones)</b>&nbsp;<img src="/tablet/help.png" border="0" class="tooltip2" title="Hay jardines, pastos y arboles: Indicar si en el parque se cuenta con uno, dos o los tres elementos."><br>
...
<br> 
<br><b>&iquest;El &aacute;rea verde y vegetacion es suficiente?</b>&nbsp;<img src="/tablet/help.png" border="0" class="tooltip2" title="Seleccione la opción que mejor describa la situación del parque."><br>
...
<br> 
<br><b>&iquest;Lo que existe est&aacute; en buen estado?</b>&nbsp;<img src="/tablet/help.png" border="0" class="tooltip2" title="Indicar si a las áreas verdes se les da el trato adecuado, que se rieguen y se poden según sus necesidades."><br>
...
<br> 
<br><b>&iquest;Con que frecuencia riega su vegetaci&oacute;n?</b>&nbsp;<img src="/tablet/help.png" border="0" class="tooltip2" title="Indicar si las áreas verdes cuentan con el riego necesario según sus condiciones y características, ya sea manual o sistematizado."><br>
...
<h2>Afluencia</h2>
<br> 
<b>&iquest;Va suficiente gente a su parque?</b>&nbsp;<img src="/tablet/help.png" border="0" class="tooltip2" title="Señalar si la cantidad de visitantes es suficiente para explotar la infraestructura existente en el parque."><br>
...
<br>
<br><b>&iquest;Va gente a su parque diario?</b>&nbsp;<img src="/tablet/help.png" border="0" class="tooltip2" title="Indicar en qué medida el parque se mantiene ocupado y utilizado durante las horas en las que se encuentra abierto. Para los espacios que cierran por cuestiones de mantenimiento o reglamentación, las visitas aplican para los días y horarios en que se encuentra abierto al público."><br>
...
<br> 
<br><b>&iquest;Qu&eacute; d&iacute;as va m&aacute;s gente?</b>&nbsp;<img src="/tablet/help.png" border="0" class="tooltip2" title="Elegir la opción que mejor describa la situación del parque."><br>
...
<br> 
<br><b>&iquest;Se usa su parque de noche?</b>&nbsp;<img src="/tablet/help.png" border="0" class="tooltip2" title="Elegir la opción que mejor describa la situación del parque."><br>
...
<h2>Orden</h2>
<br> 
<b>&iquest;Su parque se mantiene limpio?</b>&nbsp;<img src="/tablet/help.png" border="0" class="tooltip2" title="Indicar si las instalaciones se encuentran libres de basura y maleza."><br>
...
<br> 
<br><b>&iquest;Se respetan y cuidan las instalaciones de su parque?</b>&nbsp;<img src="/tablet/help.png" border="0" class="tooltip2" title="Indicar si los ciudadanos hacen uso adecuado del parque así como de su infraestructura, que no lo dañen y propicien su mantenimiento."><br>
...
<br>
<input class="btn btn-primary" type="submit" name="submit" value="Enviar"></form>';
}
echo'</form>';
?>
<?php get_footer(); ?>