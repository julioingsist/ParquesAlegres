...
$puna=$puna+$rowa11['opera']+$rowa11['formaliza']+$rowa11['organiza']+$rowa11['reunion']+$rowa11['proyecto'];
		...
		$punc=$punc+$rowa11['ingresop']+$rowa11['ingresadop'];
		$pund=$pund+$rowa11['eventos']+$rowa11['eventosr'];
		$pune=$pune+$rowa11['averdes']+$rowa11['estaver'];
                //$pun522=$pun522+$row22['averdes']+$row22['estaver']+$row22['riego'];
		$punf=$punf+$rowa11['gente']+$rowa11['diario'];
...
echo'';
	...
	echo'<p>
		<table class="clasetabla1" width="50%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" style="border-collapse:collapse;"><tr><th colspan="2"><a name="seccion1">Comit&eacute;</a></th></tr> 
<tr>
		<td bgcolor="#cede53">VISITA</td>';
...
//echo'<td align="center"><div class="create-tooltip" title="'.$tipos_visita[$row3['tipo_visita']].'" >'.$c.'</div></td>';
	...
	echo'	<tr><td bgcolor="#cede53">OPERA CON 3 PERSONAS O MAS</td>';
	$res2=mysql_query($sql2);
	$uno=0;
        $dos=0;
         while($row2=mysql_fetch_array($res2)){
	...
	echo' <td align="center">';
        ...
        //-------------------------aqui
         ...
         echo'</tr>';
	echo'	<tr><td bgcolor="#cede53">ESTA FORMALIZADO COMO A.C. / OFICIO AYUNTAMIENTO</td>';
	$res2=mysql_query($sql2);
	 while($row2=mysql_fetch_array($res2)){
	 $visita=$row2['cve'];
              $sql3="SELECT * FROM `wp_visitascom_parques` WHERE cve_parque=$parque and cve_visita=$visita";
	...
	echo' <td align="center">';
        ...
        //-------------------------aqui
         ...
         echo'</tr>';
		echo'<tr><td bgcolor="#cede53">CUENTA CON BUENA ORGANIZACION (CON ORDEN - FORMALIDAD)</td>';
		$res2=mysql_query($sql2);
	 while($row2=mysql_fetch_array($res2)){
	 $visita=$row2['cve'];
              $sql3="SELECT * FROM `wp_visitascom_parques` WHERE cve_parque=$parque and cve_visita=$visita";
	...
	echo' <td align="center">';
        ...
        //-------------------------aqui
         ...
         echo'</tr>';
		echo'<tr><td bgcolor="#cede53">EXISTEN REUNIONES CON REGULARIDAD</td>';
		$res2=mysql_query($sql2);
	 while($row2=mysql_fetch_array($res2)){
	 $visita=$row2['cve'];
              $sql3="SELECT * FROM `wp_visitascom_parques` WHERE cve_parque=$parque and cve_visita=$visita";
	...
	echo' <td align="center">';
        ...
        //-------------------------aqui
         ...
         echo'</tr>';
		echo'<tr><td bgcolor="#cede53">TIENEN PROYECTOS EN PROCESO</td>';
		$res2=mysql_query($sql2);
	 while($row2=mysql_fetch_array($res2)){
	 $visita=$row2['cve'];
              $sql3="SELECT * FROM `wp_visitascom_parques` WHERE cve_parque=$parque and cve_visita=$visita";
	...
	echo' <td align="center">';
        ...
        //-------------------------aqui
         ...
         echo'</tr>';
		echo'<tr><td bgcolor="#cede53">PUNTOS</td>';
		$res2=mysql_query($sql2);
	 while($row2=mysql_fetch_array($res2)){
             $pun=0;
...
echo'<p><table class="clasetabla1" width="50%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" style="border-collapse:collapse;"><tr><th colspan="2"><a name="seccion2">Instalaciones </a></th></tr> ';
		echo'<td bgcolor="#cede53">VISITA</td>';
			$res2=mysql_query($sql2);
	 $c=0;
	 while($row2=mysql_fetch_array($res2)){
$c++;
...
if($row3['tipo_visita']){
        ...
        echo'<tr><td bgcolor="#cede53">CUENTA CON PROYECTO DE DISE&Ntilde;O</td>';
		$res2=mysql_query($sql2);
	 while($row2=mysql_fetch_array($res2)){
	 $visita=$row2['cve'];
              $sql3="SELECT * FROM `wp_visitascom_parques` WHERE cve_parque=$parque and cve_visita=$visita";
	...
	echo' <td align="center">';
        ...
        //-------------------------aqui
         ...
         echo'</tr>';
         echo'<tr><td bgcolor="#cede53">CUENTA CON PROYECTO EJECUTIVO</td>';
		$res2=mysql_query($sql2);
	 while($row2=mysql_fetch_array($res2)){
	 $visita=$row2['cve'];
              $sql3="SELECT * FROM `wp_visitascom_parques` WHERE cve_parque=$parque and cve_visita=$visita";
	...
	echo' <td align="center">';
        ...
        //-------------------------aqui
         ...
         echo'</tr>';
         echo'<tr><td bgcolor="#cede53">ESTAN EN BUEN ESTADO LO QUE EXISTE</td>';
		$res2=mysql_query($sql2);
	 while($row2=mysql_fetch_array($res2)){
	 $visita=$row2['cve'];
              $sql3="SELECT * FROM `wp_visitascom_parques` WHERE cve_parque=$parque and cve_visita=$visita";
	...
	echo' <td align="center">';
        ...
        //-------------------------aqui
         ...
         echo'</tr>';
		echo'<tr><td bgcolor="#cede53">HAY INSTALACIONES EN LA MAYORIA DEL ESPACIO,CANCHAS, ANDADOR, BANQUETAS,ETC</td>';
		$res2=mysql_query($sql2);
	 while($row2=mysql_fetch_array($res2)){
	 $visita=$row2['cve'];
              $sql3="SELECT * FROM `wp_visitascom_parques` WHERE cve_parque=$parque and cve_visita=$visita";
...
echo'<p><table class="clasetabla1" width="50%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" style="border-collapse:collapse;"><tr><th colspan="2"><a name="seccion3">Ingresos</a> </th></tr> 
		<td bgcolor="#cede53">VISITA</td>';
		$res2=mysql_query($sql2);
	 $c=0;
	 while($row2=mysql_fetch_array($res2)){
...
if($row3['tipo_visita']){
	...
	echo'	<tr><td bgcolor="#cede53">TIENEN FUENTES DE INGRESOS PERMANENTES</td>';
	$res2=mysql_query($sql2);
	 while($row2=mysql_fetch_array($res2)){
	 $visita=$row2['cve'];
              $sql3="SELECT * FROM `wp_visitascom_parques` WHERE cve_parque=$parque and cve_visita=$visita";
	...
	echo' <td align="center">';
        ...
        //-------------------------aqui
         ...
         echo'</tr><tr>';
		echo'<td bgcolor="#cede53">ES SUFICIENTE LO INGRESADO PARA OPERAR BIEN</td>';
		$res2=mysql_query($sql2);
	 while($row2=mysql_fetch_array($res2)){
	 $visita=$row2['cve'];
              $sql3="SELECT * FROM `wp_visitascom_parques` WHERE cve_parque=$parque and cve_visita=$visita";
	...
	echo' <td align="center">';
        ...
        //-------------------------aqui
         ...
         echo'</tr>';
         echo'<tr><td bgcolor="#cede53">TIENEN CUENTA MANCOMUNADA</td>';
		$res2=mysql_query($sql2);
	 while($row2=mysql_fetch_array($res2)){
	 $visita=$row2['cve'];
              $sql3="SELECT * FROM `wp_visitascom_parques` WHERE cve_parque=$parque and cve_visita=$visita";
	...
	echo' <td align="center">';
        ...
        //-------------------------aqui
         ...
         echo'</tr><tr>';
		echo'<td bgcolor="#cede53">PUNTOS</td>';
		$res2=mysql_query($sql2);
	 while($row2=mysql_fetch_array($res2)){
             $pun3=0;
...
echo'<p><table class="clasetabla1" width="50%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" style="border-collapse:collapse;"><tr><th colspan="2"><a name="seccion4">Eventos </a></th></tr> 
		<td bgcolor="#cede53">VISITA</td>';
		$res2=mysql_query($sql2);
	 $c=0;
	 while($row2=mysql_fetch_array($res2)){
...
if($row3['tipo_visita']){
	...
	echo'	<tr><td bgcolor="#cede53">HAY EVENTOS CON REGULARIDAD</td>';
	$res2=mysql_query($sql2);
	 while($row2=mysql_fetch_array($res2)){
	 $visita=$row2['cve'];
              $sql3="SELECT * FROM `wp_visitascom_parques` WHERE cve_parque=$parque and cve_visita=$visita";
	...
	echo' <td align="center">';
        ...
        //-------------------------aqui
         ...
         echo'</tr><tr>';
		echo'<td bgcolor="#cede53"> CUENTAN CON UN CALENDARIO ANUAL DE ACTIVIDADES</td>';
		$res2=mysql_query($sql2);
	 while($row2=mysql_fetch_array($res2)){
	 $visita=$row2['cve'];
              $sql3="SELECT * FROM `wp_visitascom_parques` WHERE cve_parque=$parque and cve_visita=$visita";
...
echo'<p><table class="clasetabla1" width="50%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" style="border-collapse:collapse;"><tr><th colspan="2"><a name="seccion5">&Aacute;reas verdes</a> </th></tr> 
		<td bgcolor="#cede53">VISITA</td>';
		$res2=mysql_query($sql2);
	 $c=0;
	 while($row2=mysql_fetch_array($res2)){
...
if($row3['tipo_visita']){
		...
		echo'<tr><td bgcolor="#cede53">CUENTA CON ARBOLES, CESPED Y JARDIN</td>';
		$res2=mysql_query($sql2);
	 while($row2=mysql_fetch_array($res2)){
	 $visita=$row2['cve'];
              $sql3="SELECT * FROM `wp_visitascom_parques` WHERE cve_parque=$parque and cve_visita=$visita";
	...
	echo' <td align="center">';
        ...
        //-------------------------aqui
         ...
         echo'</tr><tr>';
		echo'<td bgcolor="#cede53">SE ENCUENTRA EN BUEN ESTADO</td>';
		$res2=mysql_query($sql2);
	 while($row2=mysql_fetch_array($res2)){
	 $visita=$row2['cve'];
              $sql3="SELECT * FROM `wp_visitascom_parques` WHERE cve_parque=$parque and cve_visita=$visita";
...
echo'<br><p>';
echo'<table class="clasetabla1" width="50%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" style="border-collapse:collapse;"><tr><th colspan="2"><a name="seccion6">Afluencia </a></th></tr> 
		<td bgcolor="#cede53">VISITA</td>';
		$res2=mysql_query($sql2);
	 $c=0;
	 while($row2=mysql_fetch_array($res2)){
...
if($row3['tipo_visita']){
	...
	echo'	<tr><td bgcolor="#cede53">PORCENTAJE DE AFLUENCIA SOBRE LO EXISTENTE</td>';
	$res2=mysql_query($sql2);
	 while($row2=mysql_fetch_array($res2)){
	 $visita=$row2['cve'];
              $sql3="SELECT * FROM `wp_visitascom_parques` WHERE cve_parque=$parque and cve_visita=$visita";
	...
	echo' <td align="center">';
        ...
        //-------------------------aqui
         ...
         echo'</tr><tr>';
	echo'	<td bgcolor="#cede53">PORCENTAJE DE AFLUENCIA CONTRA LO POSIBLE </td>';
	$res2=mysql_query($sql2);
	 while($row2=mysql_fetch_array($res2)){
	 $visita=$row2['cve'];
              $sql3="SELECT * FROM `wp_visitascom_parques` WHERE cve_parque=$parque and cve_visita=$visita";
...
echo'<br><p>';
echo'<table class="clasetabla1" width="50%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" style="border-collapse:collapse;"><tr><th colspan="2"><a name="seccion7">Orden </a></th></tr> 
		<td bgcolor="#cede53">VISITA</td>';
		$res2=mysql_query($sql2);
	 $c=0;
	 while($row2=mysql_fetch_array($res2)){
...
if($row3['tipo_visita']){
	...
	echo'<tr><td bgcolor="#cede53">LAS INSTALACIONES SE RESPETAN</td>';
		$res2=mysql_query($sql2);
	 while($row2=mysql_fetch_array($res2)){
	 $visita=$row2['cve'];
              $sql3="SELECT * FROM `wp_visitascom_parques` WHERE cve_parque=$parque and cve_visita=$visita";
	...
	echo' <td align="center">';
        ...
        //-------------------------aqui
         ...
         echo'</tr>';
         echo'<tr><td bgcolor="#cede53">SE CUENTA CON REGLAMENTEO DE ORDEN</td>';
		$res2=mysql_query($sql2);
	 while($row2=mysql_fetch_array($res2)){
	 $visita=$row2['cve'];
              $sql3="SELECT * FROM `wp_visitascom_parques` WHERE cve_parque=$parque and cve_visita=$visita";
	...
	echo' <td align="center">';
        ...
        //-------------------------aqui
         ...
         echo'</tr><tr>';
	echo'	<td bgcolor="#cede53">SE MANTIENE LIMPIO</td>';
	$res2=mysql_query($sql2);
	 while($row2=mysql_fetch_array($res2)){
	 $visita=$row2['cve'];
              $sql3="SELECT * FROM `wp_visitascom_parques` WHERE cve_parque=$parque and cve_visita=$visita";
...
//title: "Calificaci\u00F3n Parque",
 echo'var options = {
          title: "Consolidado de calificaci\u00F3n Parque",
...
if($row3['tipo_visita']){
    ...
    echo'</td></tr>';
		...
		echo'</p>';
		if($prome==0){
		echo'<a href="http://parquesalegres.org/agendar-visita/"><h3>Click aqu&iacute; para agendar visita</h3></a>';
		}	
echo'
<br><br><br>
...
function detalleparque_uno()
{
add_submenu_page( 'tools.php', __( "Arturo GC", "arturo" ), __( "Arturo GC", "arturo" ), 'export', 'arturo', 'detalleparque_dos' );
}

add_action('admin_menu', 'detalleparque_uno');
add_shortcode('detalleparque', 'detalleparque_dos');
add_shortcode('detalleparque3', 'detalleparque_tres');
