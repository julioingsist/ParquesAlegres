...
.grandBannerAlternative { clear: both; width: <?php echo $width; ?>px; height: <?php echo $height; ?>px; overflow: hidden; }
.grandBannerAlternative > div { display: none; position: relative; }
.grandBannerAlternative div img { width: 100%; max-width: 100%; height: auto; }
.grandBannerAlternative > div:first-child { display: block; }
.grandBannerAlternative a { display: block; width: <?php echo $width; ?>px; height: <?php echo $height; ?>px; overflow: hidden; }
