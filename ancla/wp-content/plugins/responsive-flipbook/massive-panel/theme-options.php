...
$options[] = array( "name" => "Page Preview", // this defines the heading of the option
	...
	$options[] = array( "name" => "HTML Content",
						...
						"help-desc"  => "Here you can specify the HTML content which will be displayed on the page. To easily place content in two columns (for left and right pages) use the columns shortcode (button to the right). To insert a video into the page please use the video shortcode.",
						"std" => "",			
						"validation" => "", 
						"type" => "textarea-big");
...
*/		
	...
	$options[] = array( "name" => "Help", // Options of type heading represent tabs for sections
						"type" => "heading");	
	...
	$options[] = array( "name" => "Save Page", // this defines the heading of the option
					...
					/* 	"stack" => "end", */
						"desc" => 'If you have a support question please visit our <a href="http://www.support.mpcreation.pl" target="_blank">support forums</a>. If you are looking for a documentation please visit <a href="http://www.mpcreation.pl/themeforest/documentation/flipbook-wp/" target="_blank">this site</a>.',
						"color" => "yellow",
						"float" => "right", // default none
						"type" => "info");
    ...
    $options[] = array("name" => "Greetings, I am Massive Panel (plugin shared on wplocker.com)", // this is the main heading from thr header
