...
if($_POST['cmd']==1){
    ...
    echo '<table><tr><td>Asesor</td><td>ID</td><td>Parque</td><td>Hojas y residuos producido por la vegetación del lugar</td><td>Tierra acumulada en exceso</td><td>Basura generada por los usuarios del parque</td><td>Restos de excremento de animales</td><td>Basura doméstica</td><td>Escombro</td><td>Muebles abandonados</td><td>Carros abandonados</td></tr>';
...
<title>Reporte de limpieza en parques</title>
...
<script>
    ...
    function buscar(){
		...
		$("#resultados").load("http://parquesalegres.org/tablet/replimpieza.php", {asesor: asesor, parque: parque, cmd: 1});
    }
    function camb(i,v){
	if(i=="proposito"){
		if(v==1){';
...
<body>';
	...
	<input type="hidden" name="cmd" value="limpieza">
    <h3 style="text-align:center">Reporte de limpieza en parques</h2><br>
