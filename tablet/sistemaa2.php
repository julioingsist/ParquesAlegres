...
$asesores=array();
$sql="select ID,cod from asesores where cod>0";
$res=mysql_query($sql);
...
if ($id_post==0){
	echo '<html><head><title>Tablet Parques Alegres</title>';
	echo '<script>function parque(p) {document.forma.parque.value=p;document.forma.submit();}</script>';
	echo '</head><body>';
	...
	$c=0;
	echo '<form name="forma" method="post" target="_blank"><input type="hidden" name="parque">';
...
<label><span><a href="javascript:void(0)" onclick="cambio(4)">Datos del Parque</a></span><span><a href="javascript:void(0)" onclick="cambio(2)">Datos del Comit&eacute</a></span></label><div style="clear:both"></div>
<label><span><a href="javascript:void(0)" onclick="cambio(6)">Experiencia Exitosa</a></span><span><a href="javascript:void(0)" onclick="cambio(5)">Check list</a></span></label></h3>';
 $sqll="select * from wp_comites_parques where cve_parque='".$_POST['parque']."' order by fecha_visita DESC, cve DESC limit 1";
    $ress=mysql_query($sqll);
    $rowz=mysql_fetch_array($ress);
...
<div class="white-half">
    ...
    <h2><label class="white-pinkon">Comit&eacute;</label><label class="white-pinkon">Anterior</label><label class="white-pinkon">Actual</label></h2>
    <label>
    ...
    <label>
        <span>Tienen proyectos en proceso:</span><input type="radio" '; if($rowz['proyecto']==20){echo ' checked';} echo ' value=20 disabled><label class="white-pinked">S&iacute</label><input type="radio" '; if($rowz['proyecto']==0 && $rowz['proyecto']!=""){echo ' checked';} echo ' value=0 disabled><label class="white-pinked">No</label><input type="radio" id="proyectos" name="proyecto" value=20><label class="white-pinked" for="proyectos">S&iacute</label><input type="radio" id="proyecton" name="proyecto" value=0><label class="white-pinked" for="proyecton">No</label>
    </label>
    <h2>Instalaciones</h2>
    <label>
    ...
    <h2>Ingresos</h2>
    <label>
        <span>Tienen fuente de ingresos permanentes:</span><input type="radio" value=30'; if($rowz['ingresop']==30){echo ' checked';} echo ' disabled><label class="white-pinked">S&iacute</label><input type="radio" value=0'; if($rowz['ingresop']==0 && $rowz['ingresop']!=""){echo ' checked';} echo ' disabled><label class="white-pinked">No</label><input type="radio" id="ingresops" name="ingresop" value=30><label class="white-pinked" for="ingresops">S&iacute</label><input type="radio" id="ingresopn" name="ingresop" value=0><label class="white-pinked" for="ingresopn">No</label>
    </label>
    <label>
    ...
    <label>
        <span>Tienen cuenta mancomunada:</span><input type="radio" value=30'; if($rowz['mancomunado']==30){echo ' checked';} echo ' disabled><label class="white-pinked">S&iacute</label><input type="radio" value=0'; if($rowz['mancomunado']==0 && $rowz['mancomunado']!=""){echo ' checked';} echo ' disabled><label class="white-pinked">No</label><input type="radio" id="mancomunados" name="mancomunado" value=30><label class="white-pinked" for="mancomunados">S&iacute</label><input type="radio" id="mancomunadon" name="mancomunado" value=0><label class="white-pinked" for="mancomunadon">No</label>
    </label>
    <h2>Eventos</h2>
    <label>
    ...
    <label>
        <span>Cuentan con un calendario anual de actividades:</span><input type="radio" value=50'; if($rowz['eventos']==50){echo ' checked';} echo ' disabled><label class="white-pinked">S&iacute</label><input type="radio" value=0'; if($rowz['eventos']==0 && $rowz['eventos']!=""){echo ' checked';} echo ' disabled><label class="white-pinked">No</label><input type="radio" id="eventoss" name="eventos" value=50><label class="white-pinked" for="eventoss">S&iacute</label><input type="radio" id="eventosn" name="eventos" value=0><label class="white-pinked" for="eventosn">No</label>
    </label>
    <h2>&Aacute;reas verdes</h2>
    <label>
        <span>Cuenta con:</span>'; if($rowz['averdes']==0 && $rowz['averdes']!=""){ echo '<label class="white-pinky">Ninguno</label>';}
        if($rowz['averdes']==17){echo '<label class="white-pinky">17</label>';}
        if($rowz['averdes']==34){echo'<label class="white-pinky">Árboles, cesped</label>';}
        if($rowz['averdes']==35){echo'<label class="white-pinky">Árboles, jardín</label>';}
        if($rowz['averdes']==36){echo'<label class="white-pinky">Cesped, jardín</label>';}
        if($rowz['averdes']==50){echo'<label class="white-pinky">Árboles, cesped, jardín</label>';}echo '<input type="checkbox" id="arboles" name="averdes[]" value="1"><label class="white-pinky" for="arboles" >&aacute;rboles</label>
        <input type="checkbox" id="cesped" name="averdes[]" value="2"><label class="white-pinky" for="cesped" >c&eacute;sped</label>
        <input type="checkbox" id="jardin" name="averdes[]" value="3"><label class="white-pinky" for="jardin" >jard&iacute;n</label>
    </label>
    <label>
...
<input type="hidden" name="cmd"><input type=hidden name="pods_meta__cmb_parque"><input type=hidden name="buscarvisita" value="0">'; echo '
</div>
</div>
...
<div id="screen4"><div class="white-pink">
    ...
    */
    echo '
    <label>
        <span>Vialidad Principal: </span><input name="vialidadprin" type="text">
    </label>
    <label>
        <span>Vialidad 1: </span><input name="vialidad1" type="text">
    </label>
    <label>
        <span>Vialidad 2: </span><input name="vialidad2" type="text">
    </label>
    <label>
        <span>Vialidad Posterior: </span><input name="vialidadpos" type="text">
    </label>
    <label>
        <span>Tipo asentamiento: </span><select name="tipoasentamiento">
            <option value="" selected> -- Seleccione -- </option>
    ...
    <label>
        <span>Nombre asentamiento: </span><input name="nomasentamiento" type="text">
    </label>
    <label>
        <span>Descripción de ubicación: </span><textarea name="descubic"></textarea>
    </label>
    <label>
        <span>Sector: </span><input name="sector" type="text">
    </label>
    <label>
        <span>Estado: </span><select name="state" id="state" onchange="addsel(5);">
            <option value=""> -- Seleccione -- </option>
    ...
    <label>
        <span>Municipio: </span><select name="ciudad" id="ciudad">
            <option value=""> -- Seleccione -- </option>
            <option value="Culiacán" selected>Culiacán</option>
            <option value="Navolato">Navolato</option>
            </select>
    ...
    <label>
        <span>Localidad: </span><select name="localidad" id="localidad">
            <option value=""> -- Seleccione -- </option>
            </select>
    </label>
